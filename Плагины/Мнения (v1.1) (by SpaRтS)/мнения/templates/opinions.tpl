...
<link rel='stylesheet' href='css/opinions.css' type='text/css' />
  ...
  <div id="wrapHI">
   <div id="header">
<h1><a href="id{$owner->user_info.user_id}">{$owner->user_info.user_name} {$owner->user_info.user_username} {$owner->user_info.user_lastname}</a> &#187; Мнения</h1>
   </div>
  </div>
  </div>
  <div id="wrap2">
  ...
  <ul class="tabs">
   <li class="activeLink">
    <a href="user_opinions.php" style="width:7em">Мнения</a>
   </li>
  </ul>
