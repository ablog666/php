...
if($task == "dodelete") {
  // START MUSIC METHOD 
  $delete = new se_music($owner);

  // DELETE THIS SONG
  $file = $url->url_userdir($owner);
  $delete->music_delete($file, $music_id);

  header("Location: admin_viewmusic.php");
  exit();
}
...
// CONFIRM SINGLE SONG ENTRY DELETION
if($task == "delete") {
...
// GET SONG LIST ARRAY
$music_list = $music->music_list_total($page_vars[0], $entries_per_page, $sort, $where);
