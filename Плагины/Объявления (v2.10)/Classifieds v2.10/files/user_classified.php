...
// SET WHERE CLAUSE
if($search != "") { $where = "(classified_title LIKE '%$search%' OR classified_body LIKE '%$search%')"; } else { $where = ""; }
...
if($task == "delete") { $classified->classifieds_delete($start, $entries_per_page, $sort, $where); }
