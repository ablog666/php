...
function upspender_promote_ontransactionstart( $params ) {
  ...
  switch($upspender->upspender_info['userpointspender_type']) {
      ...
      case 101:
        ...
        if( $classified->classifieds_total() == 0) {
          $params['err_msg'] = $functions_userpoints[84];
          return false;
        }
      ...
      case 102:
        ...
        if( $event->event_total() == 0) {
          $params['err_msg'] = $functions_userpoints[85];
          return false;
        }
      ...
      case 103:
        ...
        if( $group->group_total() == 0) {
          $params['err_msg'] = $functions_userpoints[86];
          return false;
        }
      ...
      case 104:
        ...
        if( $poll->polls_total() == 0) {
          $params['err_msg'] = $functions_userpoints[87];
          return false;
        }
...
function upspender_promote_ontransactionsuccess( $params ) {
  ...
  if(!$ad_template) {
    // rollback
    $params['err_msg'] = $functions_userpoints[71];
    return false;
  }
  ...
  switch($upspender->upspender_info['userpointspender_type']) {
    ...
    case 100:
      ...
      $params['transaction_text'] = $functions_userpoints[70];
    ...
    case 101:
      ...
      if($classified->classified_exists == 0) {
        $params['err_msg'] = $functions_userpoints[72];
        return false;
      }
      ...
      $params['transaction_text'] = $functions_userpoints[73] . " <a href='" . $url->url_create('classified', $user->user_info['user_username'], $classified_id) . "'>" . $functions_userpoints[74] . "</a>";
    ...
    case 102:
      ...
      if( $event->event_exists == 0 ) {
        $params['err_msg'] = $functions_userpoints[75];
        return false;
      }
      ...
      $params['transaction_text'] = $functions_userpoints[73] . " <a href='" . $url->url_base . "event.php?event_id=" . $event_id . "'>" . $functions_userpoints[76] . "</a>";
      break;
    ...
    case 103:
      ...
      if($group->group_exists == 0) {
        $params['err_msg'] = $functions_userpoints[77];
        return false;
      }
      ...
      $params['transaction_text'] = $functions_userpoints[73] . " <a href='" . $url->url_base . "group.php?group_id=" . $group_id . "'>" . $functions_userpoints[78] . "</a>";
      break;
    ...
    case 104:
      ...
      if($poll->poll_exists == 0) {
        $params['err_msg'] = $functions_userpoints[79];
        return false;
      }
...
*/
      ...
      $params['transaction_text'] = $functions_userpoints[73] . " <a href='" . $url->url_create('poll', $user->user_info['user_username'], $poll_id) . "'>" . $functions_userpoints[80] . "</a>";
      break;
  ...
  $transaction_message = $functions_userpoints[81];
  if($start_delta == 0) {
    $transaction_message .= $functions_userpoints[82];
  } else {
    $transaction_message .= $functions_userpoints[83];
  }
