<?
$page = "admin_userpoints_shopcomments";
...
$comment = new se_comment( 'userpointspender', 'userpointspender_id', $item_id );
...
if($task == "delete") {
  ...
  $database->database_query( "UPDATE se_semods_userpointspender SET userpointspender_comments = ( SELECT COUNT(*) FROM se_userpointspendercomments WHERE userpointspendercomment_userpointspender_id = $item_id ) WHERE userpointspender_id = $item_id" );

  header("Location: admin_userpoints_shopcomments.php?item_id=$item_id" );
}
