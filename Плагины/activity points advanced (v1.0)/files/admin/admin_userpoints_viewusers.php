...
$subnet_array[0] = Array('subnet_id' => 0, 'subnet_name' => $admin_userpoints_viewusers[26]);
...
while($user_info = $database->database_fetch_assoc($users_dbr)) {
  ...
  $user_info['user_enabled'] = $user_info['user_enabled'] ? $admin_userpoints_viewusers[9] : $admin_userpoints_viewusers[10];
