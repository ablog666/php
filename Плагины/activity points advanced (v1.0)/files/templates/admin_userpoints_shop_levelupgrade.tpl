...
<h2>{$admin_userpoints_shop_levelupgrade1}</h2>
{$admin_userpoints_shop_levelupgrade2}

<br><br>
<table class='tabs' cellpadding='0' cellspacing='0'>
<tr>
<td class='tab0'>&nbsp;</td>
<td class='tab1' NOWRAP>{if $item_id !=0}<a href='admin_userpoints_shop.php?task=edit&item_id={$item_id}'>{$admin_userpoints_shop_levelupgrade40}{else}{$admin_userpoints_shop_levelupgrade40}{/if}</a></td>
<td class='tab'>&nbsp;</td>
<td class='tab2' NOWRAP>{if $item_id !=0}<a href='admin_userpoints_shopphoto.php?item_id={$item_id}'>{$admin_userpoints_shop_levelupgrade41}</a>{else}{$admin_userpoints_shop_levelupgrade41}{/if}</td>
<td class='tab'>&nbsp;</td>
<td class='tab2' NOWRAP>{if $item_id !=0}<a href='admin_userpoints_shopcomments.php?item_id={$item_id}'>{$admin_userpoints_shop_levelupgrade42}</a>{else}{$admin_userpoints_shop_levelupgrade42}{/if}</td>
<td class='tab3'>&nbsp;<a href='admin_userpoints_shop.php'>&#171; &nbsp; {$admin_userpoints_shop_levelupgrade43}</a></td>
</tr>
</table>
...
<tr>
<td class='form1'>{$admin_userpoints_shop_levelupgrade6}</td>
<td class='form2'> 
...
<tr>
<td class='form1'>{$admin_userpoints_shop_levelupgrade28}</td>
<td class='form2'>


<input id="offer_levels_input" type="text" readonly="readonly" class="multiSelect" value="{$admin_userpoints_shop_levelupgrade30}" style="cursor: default;" />
...
<label class="selectAll"><input type="checkbox" class="selectAll" /> {$admin_userpoints_shop_levelupgrade31} </label>
{section name=level_loop loop=$levels}
<label><input type="checkbox" name="offer_levels[]" value="{$levels[level_loop].level_id}" {if $levels[level_loop].level_selected} checked="checked" {/if}/> {$levels[level_loop].level_name} {if $levels[level_loop].level_default} {$admin_userpoints_shop_levelupgrade27} {/if} </label>
{/section}
</div>
...
<tr>
<td class='form1'>{$admin_userpoints_shop_levelupgrade29}</td>
<td class='form2'>


<input id="offer_subnets_input" type="text" readonly="readonly" class="multiSelect" value="{$admin_userpoints_shop_levelupgrade30}" style="cursor: default;" />
...
<tr>
<td class='form1'>{$admin_userpoints_shop_levelupgrade11}</td>
<td class='form2'>

<select class='text' name='offer_enabled'>
<option value='1'{if $offer_enabled == 1} SELECTED{/if}>{$admin_userpoints_shop_levelupgrade12}</option>
<option value='0'{if $offer_enabled == 0} SELECTED{/if}>{$admin_userpoints_shop_levelupgrade13}</option>
</select>
...
<tr>
<td class='form1'>{$admin_userpoints_shop_levelupgrade17}</td>
<td class='form2'>

<select class='text' name='offer_allow_comments'>
<option value='1'{if $offer_allow_comments == 1} SELECTED{/if}>{$admin_userpoints_shop_levelupgrade24}</option>
<option value='0'{if $offer_allow_comments == 0} SELECTED{/if}>{$admin_userpoints_shop_levelupgrade25}</option>
</select>
...
<tr>
<td class='form1'>{$admin_userpoints_shop_levelupgrade16}</td>
...
<td class='form2'>
  <table cellpadding='0' cellspacing='0'>
  <tr>
  <td><input type='submit' class='button' value='{$admin_userpoints_shop_levelupgrade9}'>&nbsp;</td>
  <input type='hidden' name='task' value='addoffer'>
  <input type='hidden' name='item_id' value='{$item_id}'>
  </form>
  <form action='admin_userpoints_shop.php' method='POST'>
  <td><input type='submit' class='button' value='{$admin_userpoints_shop_levelupgrade10}'></td>
  </tr>
  </form>
  </table>
</td>
