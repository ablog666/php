...
$functions_userpoints[10] = "Thank you for your order!  You transaction will be approved after we recieve confirmation from payment company (usually almost instantly).";
...
switch ($page) {
  ...
  case "admin_userpoints":
	...
	$admin_userpoints[4] = "Enable Activity Points?";
	$admin_userpoints[5] = "Do you want to allow users receive points for actions?";
	$admin_userpoints[6] = "Yes, enable activity points.";
	$admin_userpoints[7] = "No, disable activity points.";
