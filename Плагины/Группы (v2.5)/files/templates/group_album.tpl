...
<div class='page_header'><img src='./images/icons/album22.gif' border='0' class='icon'> <a href='group.php?group_id={$group->group_info.group_id}'>{$group->group_info.group_title}</a>{$group_album2}</div>
